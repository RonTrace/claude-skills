...
- `pillow` - Required for `.as_image()` method and saving images
...
2. Verify GOOGLE_API_KEY is set - you can find it in the .env file in the root of your skills directory.
...
|------|----------|--------------|
| [references/guide.md](references/guide.md) | Advanced features: thinking process, Google Search grounding, multi-turn conversations, professional asset production, model comparison | Need advanced image generation features beyond basic prompts |
